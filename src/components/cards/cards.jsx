...
const Card = (props) => {
  return(
    <div className={`card ${props.link==='none' ? 'tooltip' : ''}`}>
      <a href={props.link} rel='noopener noreferrer' target='_blank'>
        <div className='card__imageholder'>
          <img src={props.img} />
        </div>
        <div className='card__textholder'>
          <div className='card__textholder__heading'>{props.heading}    <span className={`tooltiptext ${props.link==='none' ? '' : 'no-display'}`}>Coming Soon!</span></div>
